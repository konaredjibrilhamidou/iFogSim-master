...
public class TwoApps {
	...
	public static void main(String[] args) {
		...
		try {
			...
			moduleMapping_0.addModuleToDevice("concentration_calculator", "proxy-server"); // fixing all instances of the Concentration Calculator module to the Cloud
	...
	private static FogDevice addGw(String id, int parentId){
		FogDevice dept = createFogDevice(
				...
				"d-"+id, 2800, 4000, 10000, 10000, 1, 0.0, 107.339, 83.4333);
		fogDevices.add(dept);
